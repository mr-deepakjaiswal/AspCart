...
export default function AdminEarningsPage() {
  ...
  return (
    <div>
      {selectedTab === 'SellerDashboard' ? <Seller /> : <div>
        <div className='w-full bg-white p-6 flex md:flex-row flex-col gap-4'>
          <div className='border-2 rounded-lg md:w-1/3 p-6 text-center flex flex-col gap-2 flex-wrap'>
          ...
          <div className='border-2 rounded-lg md:w-1/3 p-6 text-center flex flex-col gap-2 flex-wrap bg-red-600 text-white'>
            <h1 className='font-semibold'>View your balance via</h1>
            <button className={`text-xl font-bold underline ${selectedTab === 'SellerDashboard' ? 'border-b-2 text-red-700 border-red-700' : ''}`}
              onClick={() => handleTabClick('SellerDashboard')}
