...
import SavedCreditCardsPages from './SavedCreditCardsPages';
import EmailSettingPage from './EmailSettingsPage';
import SocialNetworksPages from './SocialNetworksPages';
...
export default function SettingPage() {
  ...
  return (<div className='flex gap-6'>
    ...
    <div className='bg-white flex flex-col gap-4 h-min w-2/6 p-4 rounded-lg border-s-8 border-s-red-600'>
      ...
      <h1>Your username,email and password can be updated via your <button className='text-indigo-900 font-bold'> AspCart Account settings.</button>
      </h1>
      </h1>
    </div>
  </div>
