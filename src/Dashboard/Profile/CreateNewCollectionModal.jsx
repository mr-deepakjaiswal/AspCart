      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            type="file"
            id="coverImage"
            className="shadow appearance-none border rounded md:w-1/4 w-40 py-2 px-3  leading-tight focus:outline-none focus:shadow-outline"
       ...
       {/*footer*/}
        <div className="flex flex-wrap justify-center gap-4 md-gap-0 md:justify-start">
          <button
            type="submit"
