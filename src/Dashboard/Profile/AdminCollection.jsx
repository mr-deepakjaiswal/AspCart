        ...
        <div className='flex gap-4 justify-between'>
          ...
          <div className='flex flex-col gap-1'>
            ...
            <div className='flex justify-end gap-2'>
              <button className='p-1 text-sm border-2 rounded-md text-yellow-500 border-yellow-500'><FaShare /></button>
              <button className='p-1 text-sm border-2 rounded-md text-indigo-700 border-indigo-700'><FaPen /></button>
              <button className='p-1 text-sm border-2 rounded-md text-red-600 border-red-600'><RiDeleteBin6Line /></button>
            </div>
          </div>
        </div>
      </div>
