...
export default function FollowingsPage() {
  return (
    ...
    <div className='flex flex-wrap flex-col gap-6 bg-white md:w-3/4 md:p-4 rounded-lg'>
      <div className='shadow-md py-2'>
        <div className='flex flex-wrap gap-8 items-center justify-center md:justify-start '>
          ...
          <div className='flex flex-wrap flex-col gap-2'>
            <h1 className='text-lg font-bold text-center md:text-start'>PIXINVENT</h1>
            <p className='text-sm text-center md:text-start'>11 Items <br />751 Followers <br />Member Since: December 2011 <br />Available for freelance work</p>
          </div>

          <div className='ms-12 md:block hidden flex-wrap flex-col gap-4'>
            <div>
              <img  src={Group1} alt="" />
            </div>
            <div>
    ...
    <div className='bg-white h-min md:w-2/6 p-4 rounded-lg border-s-8 border-s-red-600'>
